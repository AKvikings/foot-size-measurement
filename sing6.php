...
$extension = end(explode(".", $_FILES["file"]["name"]));
  ...
  if ($_FILES["file"]["error"] > 0)
    ...
    #  echo $_FILES["file"]["name"] . " already exists. ";
     ...
     #ss echo "Stored in: " . "upload/" . $_FILES["file"]["name"];
      }
    }
    $v=$_FILES["file"]["name"];
    $img="upload/".$v;
    #echo'<img src="'.$img.'">';
    $g="ajith";
    $exe=exec("python object_size.py 2>&1"."$img");
    $_SESSION['exe']=$exe;
    echo"<h3>Your order Foot size is  ".$exe."</h3>";
...
?> </div>
			<div class="col-md-8 single-right-left simpleCart_shelfItem">
				<h3>RUNNING SHOE</h3>
				<p><span class="item_price">RS 875</span>
					<del>Rs1,199</del>
				</p>
				<div class="rating1">
					<ul class="stars">
